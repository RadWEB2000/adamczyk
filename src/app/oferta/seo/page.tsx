          ...
          <Hero
              breadcrumbs={{
                  items:[
                      ...
                      {
                        href:'/oferta/seo',
                        label:'Pozycjonownie SEO'
                      }
                  ]
              }}
              subtitle="Pozycjonowanie stron"
              title="Budowanie widoczoności stron w wyszukiwarkach internetowych"
              content="Pozycjonowanie stron WWW to strategia zwiększania widoczności strony w wynikach organicznych wyszukiwarek, która ma na celu przyciągnięcie większej liczby odwiedzających. Proces ten obejmuje optymalizację treści strony pod kątem odpowiednich słów kluczowych oraz ulepszanie aspektów technicznych witryny, aby była ona przyjazna dla algorytmów wyszukiwarek."
          />
          <main
